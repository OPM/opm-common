...
template<>
const std::vector<int>& ERst::getRst<int>(const std::string& name, int reportStepNumber) const
{
...
template<>
const std::vector<float>& ERst::getRst<float>(const std::string& name, int reportStepNumber) const
{
    int ind = getArrayIndex(name, reportStepNumber);
...
template<>
const std::vector<double>& ERst::getRst<double>(const std::string& name, int reportStepNumber) const
{
    int ind = getArrayIndex(name, reportStepNumber);
...
template<>
const std::vector<bool>& ERst::getRst<bool>(const std::string& name, int reportStepNumber) const
{
    int ind = getArrayIndex(name, reportStepNumber);
...
template<>
const std::vector<std::string>& ERst::getRst<std::string>(const std::string& name, int reportStepNumber) const
{
    int ind = getArrayIndex(name, reportStepNumber);

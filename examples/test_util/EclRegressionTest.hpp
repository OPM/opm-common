...
private:
    ...
    void printMissingKeywords(const std::vector<std::string> arrayList1, const std::vector<std::string> arrayList2) const;

    void compareKeywords(const std::vector<std::string> &keywords1, const std::vector<std::string> &keywords2, const std::string &reference);

    void checkSpesificKeyword(std::vector<std::string> &keywords1, std::vector<std::string> &keywords2, std::vector<EIOD::eclArrType> &arrayType1, std::vector<EIOD::eclArrType> &arrayType2, const std::string &reference);

    template <typename T>
    void compareVectors(const std::vector<T> & t1, const std::vector<T> & t2, const std::string keyword, const std::string reference);

    template <typename T>
    void compareFloatingPointVectors(const std::vector<T> & t1, const std::vector<T> & t2, const std::string keyword, const std::string reference);
    ...
    void deviationsForCell(double val1, double val2, const std::string& keyword, const std::string reference, size_t kw_size, size_t cell, bool allowNegativeValues, bool useStrictTol);

    template <typename T>
    void deviationsForNonFloatingPoints(T val1, T val2, const std::string& keyword, const std::string reference, size_t kw_size, size_t cell);

...
void EGrid::dimension(int &i,int &j,int &k){
...
void EGrid::getCellCorner(const int &i, const int &j, const int &k, std::vector<double> &X, std::vector<double>& Y, std::vector<double>& Z) const {

...
DensityTable make_density_table(const GravityTable& gravity) {
    ...
    void TableManager::initSimpleTables(const Deck& deck) {
        ...
        addTables( "JOULETHO", m_tabdims.getNumPVTTables());
        ...
        initSimpleTableContainer<JoulethomsonTable>(deck, "JOULETHO" , m_tabdims.getNumPVTTables());

...
static char * ecl_kw_alloc_output_buffer(const ::Opm::RestartIO::ecl_kw_type * ecl_kw) {
...
static void ecl_kw_fwrite_data_unformatted( const ::Opm::RestartIO::ecl_kw_type * ecl_kw , fortio_type * fortio ) {

                    ...
                    IGrpArray&               iGrp)
{
    ...
    if (group.hasInjectionControl(Opm::Phase::WATER)) {
        ...
        if (is_field) {
            ...
            const auto& group_control_available = group.injectionGroupControlAvailable(Opm::Phase::WATER);
    ...
    if (group.hasInjectionControl(Opm::Phase::GAS)) {
        if (is_field) {
            ...
            const auto& group_control_available = group.injectionGroupControlAvailable(Opm::Phase::GAS);

...
EXTRA_MODULE_FLAGS[opm-simulators]="-DBUILD_EBOS_EXTENSIONS=ON -DBUILD_EBOS_DEBUG_EXTENSIONS=ON -DBUILD_FLOW_VARIANTS=ON -DENABLE_3DPROPS_TESTING=ON"
...
EXTRA_MODULE_FLAGS[opm-material]="-DENABLE_3DPROPS_TESTING=ON"
EXTRA_MODULE_FLAGS[opm-grid]="-DENABLE_3DPROPS_TESTING=ON"

...
macro(opm_doc opm doxy_dir)
  ...
  if(EXISTS ${PROJECT_SOURCE_DIR}/${doxy_dir}/DoxygenLayout.xml)
    file(
      COPY
        ${PROJECT_SOURCE_DIR}/${doxy_dir}/DoxygenLayout.xml
      DESTINATION
        ${PROJECT_BINARY_DIR}/${doxy_dir}
    )
  else()
    file(
      COPY
        ${OPM_MACROS_ROOT}/cmake/Templates/DoxygenLayout.xml
      DESTINATION
        ${PROJECT_BINARY_DIR}/${doxy_dir}
    )
  endif()
  ...
  if(DOXYGEN_FOUND)
    ...
    foreach(format IN LISTS _formats)
      ...
      install(
        DIRECTORY
          ${PROJECT_BINARY_DIR}/${doxy_dir}/${format}
        DESTINATION
      ...
      add_custom_target(install-${format}
        COMMAND
          ${CMAKE_COMMAND} -DCOMPONENT=${format} -P cmake_install.cmake
        COMMENT
          Installing ${FORMAT} documentation
        VERBATIM
      )
  ...
  if((NOT PROJECT_SOURCE_DIR STREQUAL PROJECT_BINARY_DIR) AND (EXISTS ${PROJECT_SOURCE_DIR}/${doxy_dir}/style.css))
    file(
      COPY
        ${PROJECT_SOURCE_DIR}/${doxy_dir}/style.css
      DESTINATION
        ${PROJECT_BINARY_DIR}/${doxy_dir}
    )

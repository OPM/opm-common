...
macro (opm_compile_satellites opm satellite excl_all test_regexp)
  ...
  foreach (_sat_FILE IN LISTS ${satellite}_SOURCES)
    ...
    use_warnings(TARGET ${_sat_NAME})
    use_fast_build(TARGET ${_sat_NAME})
    use_additional_optimization(TARGET ${_sat_NAME})
    use_only_needed(TARGET ${_sat_NAME})
    use_threads(TARGET ${_sat_NAME})
    use_runpath(TARGET ${_sat_NAME})
...
macro(opm_add_test TestName)
  ...
  if (NOT SKIP_CUR_TEST)
    if (CURTEST_ONLY_COMPILE)
      ...
      use_warnings(TARGET ${CURTEST_EXE_NAME})
      use_fast_build(TARGET ${CURTEST_EXE_NAME})
      use_additional_optimization(TARGET ${CURTEST_EXE_NAME})
      use_only_needed(TARGET ${CURTEST_EXE_NAME})
      use_threads(TARGET ${CURTEST_EXE_NAME})
      use_runpath(TARGET ${CURTEST_EXE_NAME})

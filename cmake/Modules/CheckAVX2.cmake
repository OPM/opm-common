...
"
  ...
  if(NOT TARGET CpuFeatures::AVX2)
    add_library(CpuFeatures::AVX2 INTERFACE IMPORTED)
    if(HAVE_AVX2_EXTENSION)
      set_property(TARGET CpuFeatures::AVX2 PROPERTY
        INTERFACE_COMPILE_OPTIONS ${AVX2_FLAGS})
    endif()
  endif()
endmacro()

...
///
/// Manages how how well lists are created (NEW), how new wells are added to
/// new or existing lists (ADD), how wells move between well lists (MOV),
/// and how to remove a set of wells from an existing well list (DEL).
class WListManager
{
public:
    /// Default constructor.
    ...
    /// Mutable version.
    ///
    /// Will throw an exception if the the well list does not exist.  Use

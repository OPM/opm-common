 ...
 */
#ifndef OPM_PARSER_JOULETHOMSON_TABLE_HPP
#define OPM_PARSER_JOULETHOMSON_TABLE_HPP
...
class JoulethomsonTable : public SimpleTable {
public:
    JoulethomsonTable( const DeckItem& item );

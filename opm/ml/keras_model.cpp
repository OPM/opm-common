...
//     Tensor<Evaluation>  ht_1 = Tensor<Evaluation>(1, outputDim);
//     Tensor<Evaluation>  ct_1 = Tensor<Evaluation>(1, outputDim);
//
//     ht_1.Fill(0.0f);
//     ct_1.Fill(0.0f);
//
...
bool KerasModel<Evaluation>::LoadModel(const std::string& filename) {
    ...
    for (unsigned int i = 0; i < num_layers; i++) {
        ...
        switch (layer_type) {
        // case kConvolution2d:
        //    layer = new KerasLayerConvolution2d<Evaluation>();
        //     break;
        case kFlatten:
        ...
        case kDense:
            ...
            break;
        // case kElu:
        //    layer = new KerasLayerElu<Evaluation>();
        //     break;
        case kActivation:
            layer = new KerasLayerActivation<Evaluation>();
            break;
        // case kMaxPooling2D:
        //    // layer = new KerasLayerMaxPooling2d<Evaluation>();
        //     break;
        // case kLSTM:
        //    // layer = new KerasLayerLSTM<Evaluation>();
        //     break;
        // case kEmbedding:
        // //    layer = new KerasLayerEmbedding<Evaluation>();
            // break;
        default:
            break;
        }

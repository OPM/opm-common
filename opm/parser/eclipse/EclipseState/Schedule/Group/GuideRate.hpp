...
struct GuideRateValue {
    ...
    GuideRateValue(double v, GuideRateModel::Target tg):
        value(v),
        target(tg)
    {}
...
public:
    ...
    void update_time_stamp(double sim_time, size_t report_step);
...
private:
    ...
    bool time_to_update(double sim_time, size_t report_step) const;

...
constexpr int NUM_PHASES_IN_ENUM = static_cast<int>(Phase::SALT) + 1;  // Used to get correct size of the bitset in class Phases.
...
class Phases {
    public:
        ...
        Phases( bool oil, bool gas, bool wat, bool solvent = false, bool polymer = false, bool energy = false,
                bool polymw = false, bool foam = false, bool brine = false, bool salt = false ) noexcept;

...
extern "C" {
    ...
    Opm::Schedule * schedule_alloc(Opm::ParseContext * context, Opm::EclipseGrid * grid, Opm::Eclipse3DProperties * props, Opm::Deck * deck);
    ...
    Opm::Schedule * schedule_alloc(Opm::ParseContext * context, Opm::EclipseGrid * grid, Opm::Eclipse3DProperties * props, Opm::Deck * deck) {
        return new Opm::Schedule( *context , *grid, *props, *deck, Opm::Runspec(*deck).phases() );
    }

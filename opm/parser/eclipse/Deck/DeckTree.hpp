...
public:
    ...
    void add_include(const std::string& parent_file, const std::string& include_file);
    std::size_t size(const std::string& fname) const;
    void add_keyword(const std::string& fname);
...
private:
    ...
    bool includes_empty(const std::string& parent_file, const std::string& include_file) const;

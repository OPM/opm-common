...
namespace gpuistl{
    ...
    WaterPvtMultiplexer<Scalar, true, true, ViewDouble, ViewScalar, false>
    make_view(WaterPvtMultiplexer<Scalar, true, true, GPUContainerDouble, GPUContainerScalar, true>& waterMultiplexer)
    {
        ...
        return WaterPvtMultiplexer<Scalar, true, true, ViewDouble, ViewScalar, false>(WaterPvtApproach::BrineCo2, gpuPvtView);
    }
}

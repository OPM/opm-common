...
void initFromState(const EclipseState& eclState, const Schedule&);
    ...
    */
     ...
     * \brief Returns the specific enthalpy [J/kg] of gas given a set of parameters.
     */
    template <class Evaluation, class CO2T>
    OPM_HOST_DEVICE Evaluation internalEnergy(CO2T& co2,
                        unsigned regionIdx,
                        const Evaluation& temperature,
                        const Evaluation& pressure,
                        const Evaluation& rv,
     ...
     */
    template <class Evaluation>
    OPM_HOST_DEVICE Evaluation saturatedViscosity(CO2& co2,
                                 unsigned /*regionIdx*/,
                                  const Evaluation& temperature,
                                  const Evaluation& pressure) const
    {
     ...
     */
    template <class Evaluation>
    OPM_HOST_DEVICE Evaluation inverseFormationVolumeFactor(CO2 co2,
                                            unsigned regionIdx,
                                            const Evaluation& temperature,
                                            const Evaluation& pressure,
                                            const Evaluation& rv,
...
namespace Opm::gpuistl{
    ...
    move_to_gpu(Co2GasPvt<Scalar> cpuCo2){
        return Co2GasPvt<Scalar, GPUContainer>(GPUContainer(cpuCo2.getBrineReferenceDensity()),
    ...
    make_view(const Co2GasPvt<Scalar, ContainerType>& co2GasPvt) {
        ...
        return Co2GasPvt<Scalar, ViewType>(newBrineReferenceDensity,

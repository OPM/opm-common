...
// template<class Scalar, class ContainerT>
// OPM_HOST_DEVICE Co2GasPvt<Scalar, ContainerT>::
// Co2GasPvt(ContainerT brineReferenceDensity,
...
// template<class Scalar, class ContainerT>
// OPM_HOST_DEVICE void Co2GasPvt<Scalar, ContainerT>::

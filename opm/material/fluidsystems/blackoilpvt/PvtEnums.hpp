 ...
 */
#ifndef PVT_ENUMS_HPP
#define PVT_ENUMS_HPP

namespace Opm {

//! \brief Enumeration of available gas PVTs.
...
//! \brief Enumeration of available oil PVTs.
...
//! \brief Enumeration of available water PVTs.

...
BOOST_AUTO_TEST_CASE(UDAControl_IUAD_0)
{
    ...
    BOOST_CHECK_EQUAL(UDQ::udaCode(UDAControl::WCONPROD_RESV), 999'999);
    BOOST_CHECK_EQUAL(UDQ::udaCode(UDAControl::WCONPROD_BHP),  999'999);
    BOOST_CHECK_EQUAL(UDQ::udaCode(UDAControl::WCONPROD_THP),  999'999);
    ...
    BOOST_CHECK_EQUAL(UDQ::udaCode(UDAControl::WCONINJE_BHP),  999'999);
    BOOST_CHECK_EQUAL(UDQ::udaCode(UDAControl::WCONINJE_THP),  999'999);
